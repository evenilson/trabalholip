      ...
      <div class="container">
         ...
         <div class="row">
            <div class="col-sm-4">
               <div class="container">
                  <div>
                     <a class="card-options" href="../components/adventure/pages/sales.php">
                        ...
                        <div class="details">
                           <span 
                              ...
                              ?>>
                              <?php echo $qtdAdventure[0] ?> em estoque</span>
                        </div>
                     </a>
                  </div>
               </div>
                     ...
                     <a class="card-options" href="../components/comedy/pages/sales.php">
                        ...
                        <div class="details">
                           <span 
                              ...
                              ?>>
                           <?php echo $qtdComedy[0] ?> em estoque</span>
                        </div>
                     </a>
                  </div>
               </div>
            ...
            <div class="col-sm-4">
               <div class="container">
                  <div>
                     <a class="card-options" href="../components/drama/pages/sales.php">
                        ...
                        <div class="details">
                           <span
                              ...
                              ?>>
                           <?php echo $qtdDrama[0] ?> em estoque</span>
                        </div>
                     </a>
                  </div>
               </div>
